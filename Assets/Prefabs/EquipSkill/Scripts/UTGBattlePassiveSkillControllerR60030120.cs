...
public class UTGBattlePassiveSkillControllerR60030120 : NTGBattlePassiveSkillController
{
    public override void Notify(NTGBattlePassive.Event e, object param)
    {
        ...
        if (e == NTGBattlePassive.Event.Hit)
        {
            ...
            if ((p.shooter == owner) && (p.behaviour.type == NTGBattleSkillType.Attack) && p.critical)
            {

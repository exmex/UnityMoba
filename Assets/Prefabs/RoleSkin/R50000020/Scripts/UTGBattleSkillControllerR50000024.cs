...
public class UTGBattleSkillControllerR50000024 : UTGBattleSkillControllerMultiStage
{
    ...
    public override bool ShootCheck(NTGBattleUnitController targetUnit, float xOffset, float zOffset)
    {
        ...
        {
            if (passive.name == "PBehaviourR600000211")
            {
                specialAttack = true;
                break;
            }
    ...
    public override void Shoot(NTGBattleUnitController targetUnit, float xOffset, float zOffset)
    {
        ...
        if (specialAttack)
        {
            owner.RemovePassive("PBehaviourR600000211");

...
class("GuildNoAPI")
----------------------------------------------------
function GuildNoAPI:Awake(this) 
  self.this = this  
  -------------------------------------
  GuildNoAPI.Instance=self;
  -------------------------------------
  self:SetParam() 
...
function GuildNoAPI:Start()
  ...
  self.topAPI:GoToPosition("GuildNoPanel")
...
----------------------------------------------------
function GuildNoAPI:OnDestroy() 
  coroutine.stop(self.Coro_ShowPanel)
  coroutine.stop(self.Co_CountDownRevive)
  
  ------------------------------------
  GuildNoAPI.Instance=nil;
  ------------------------------------
  self.this = nil
  self = nil
...
------------------------------------------参数赋值--
function GuildNoAPI:SetParam()  --引用及初始值
...
------------------------------------------------------------
function GuildNoAPI:ShowPanel(index1,index2)  --指定打开某节点，及其某子节点，关闭其他
  --Debugger.LogError(index1) Debugger.LogError(index2)
  --if(IsNil(v.gameObject))then  Debugger.LogError("NULL2") end
  --self.Coro_ShowPanel= coroutine.start( self.ShowPanel_Coro,self, index1,index2)
...
------------------------------------------------------------
function GuildNoAPI:Initialize() 
...
------------------------------------------------------------
function GuildNoAPI:OnButtonClick_I1()  --战队列表
  --self:ShowPanel("I","I1"); 
...
function GuildNoAPI:OnButtonClick_I2()  --筹备战队列表
...
function GuildNoAPI:OnButtonClick_I3()  --筹备战队列表

  self:ShowPanel("I","I3");  ------------------------------------------------------------------------------------------------->>

end
function GuildNoAPI:OnButtonClick_II1()  --战队-信息-界面
...
function GuildNoAPI:OnButtonClick_II2()  --战队-成员-界面
...
function GuildNoAPI:OnButtonClick_III1()  --战队-排行榜-本周
...
function GuildNoAPI:OnButtonClick_III2()  --战队-排行榜-上周
...
function GuildNoAPI:OnButtonClick_III3()  --战队-排行榜-赛季跳转
...
function GuildNoAPI:OnButtonClick_III3I()  --战队-排行榜-同等级赛季
...
function GuildNoAPI:OnButtonClick_III3II()  --战队-排行榜-赛季
...
------------------------------------------------------------
function GuildNoAPI:AddListener()
    --[[
    --添加好友验证信息确定按钮
...
function GuildNoAPI:Instantiate(mTable,prefabName,parent,obj,func,single)
...
function GuildNoAPI:InstantiateCoro(mTable,prefabName,parent,obj,func,single)
    local amount=0
...
-----------------------------------------------赋值回调--
function GuildNoAPI:Assignment_GuildIcon(go,key,guildIcon)  --赋值战队图标
...
function GuildNoAPI:Assignment_GuildIconII(go,key,guildIcon)  --赋值战队图标II
...
function GuildNoAPI:Assignment_GuildList(go,key,v)  --赋值战队列表 --guildInfo
...
function GuildNoAPI:Assignment_PreparingGuildList(go,key,v) --赋值筹备列表 
...
function GuildNoAPI:Assignment_PreparingGuildMembers(go,key,v) --赋值成员列表  --data.PreparingGuild.PreparingGuildInfo  --data.PreparingGuild.Members 
...
----------------------------------------
function GuildNoAPI:DoGoToPlayerDataPanel(v)
  -- body
  coroutine.start(self.GoToPlayerDataPanel, self,v)
end

function GuildNoAPI:GoToPlayerDataPanel(v)
  -- body
...
----------------------------------------
function GuildNoAPI:DoGoToGuildListPanel()
  -- body
  coroutine.start(self.GoToGuildListPanel, self,v)
end

function GuildNoAPI:GoToGuildListPanel()
  -- body
...
-------------------------------------------------------------------------------------------------------------加入战队后--
function GuildNoAPI:Assignment_GuildMembers(go,key,v,index,isEnd) --战队信息 
...
function GuildNoAPI:DoInNextFrame(func,obj,param1,param2) 
  coroutine.start(self.DoInNextFrame_Co,self,func,obj,param1,param2)
end
function GuildNoAPI:DoInNextFrame_Co(func,obj,param1,param2) 
  --coroutine.step()
  while(true)do
    coroutine.step()
...
function GuildNoAPI:Assignment_GuildLogList(go,key,v,index)  
...
-------------------------------------------------------------------------------------------------------------加入战队后--
function GuildNoAPI:ShowNumII(num,tempo) --排行数字 
...
function GuildNoAPI:ShowNum(num,tempo) --排行数字 
...
-------------------------------------------------------------------------------------------------------------加入战队后--
function GuildNoAPI:Assignment_GuildMembersII(go,key,v,index) --战队成员 
...
function GuildNoAPI:GetStringTime(t)
...
--------------------------------------------------------------------------------获取战队申请列表--
function GuildNoAPI:Assignment_ApplicationList(go,key,v,index) --战队成员
...
function GuildNoAPI:Assignment_GuildLastWeekRank(go,key,v,index) --获取上周战队排行
...
function GuildNoAPI:Assignment_GuildWeekRank(go,key,v,index) --获取上周战队排行
...
function GuildNoAPI:Assignment_GuildLevelSeasonRank(go,key,v,index) --获取上周战队排行
...
function GuildNoAPI:Assignment_GuildSeasonRank(go,key,v,index) --获取上周战队排行
...
function GuildNoAPI:InitSelf_GuildLastWeekRank(v)
  --------------------------将自己战队信息填充到界面底部-----------------------
...
function GuildNoAPI:InitSelf_GuildWeekRank(v)
...
function GuildNoAPI:InitSelf_GuildLevelSeasonRank(v)
...
function GuildNoAPI:InitSelf_GuildSeasonRank(v)
...
----------------------------------------------------------------------------------------------------------------创建战队--
function GuildNoAPI:CreateGuildRequest()  
...
function GuildNoAPI:RefreshI3()  --刷新创建战队界面  
...
----------------------------------------------------------------------
function GuildNoAPI:CreateGuildResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------获取战队列表--
function GuildNoAPI:GuildListRequest( beginIndex , length )   --索引，增量
...
----------------------------------------------------------------------
function GuildNoAPI:GuildListResponseHandler(e)
  ...
  if e.Type == "RequestGuildList" then
    ...
    elseif(data.Result==1)then  
      ...
      if(#data.GuildList<=0)then --每次初始化没有Item右侧不显示，否则赋值第一个之后显示
...
--------------------------------------------------------------------------------------------------------------申请加入战队--
function GuildNoAPI:ApplyGuildRequest(guildId)   
...
----------------------------------------------------------------------
function GuildNoAPI:ApplyGuildResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------搜索战队--
function GuildNoAPI:SearchGuildRequest()  --RequestSearchGuild
...
----------------------------------------------------------------------
function GuildNoAPI:SearchGuildResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------获取筹备列表--
function GuildNoAPI:PreparingGuildListRequest( beginIndex , length )   --索引，增量  RequestPreparingGuildList
...
----------------------------------------------------------------------
function GuildNoAPI:PreparingGuildListResponseHandler(e)
...
--------------------------------------------------------------------------------------------------------------响应筹备战队--
function GuildNoAPI:JoinPreparingGuildRequest(guildId)   
...
----------------------------------------------------------------------
function GuildNoAPI:JoinPreparingGuildResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------搜索筹备战队--
function GuildNoAPI:SearchPreparingGuildRequest()  --RequestSearchGuild
...
----------------------------------------------------------------------
function GuildNoAPI:SearchPreparingGuildResponseHandler(e)
...
--[[
----------------------------------------------------------------------------------------------------------------筹备中--
function GuildNoAPI:MyselfPreparingGuildDetailRequest()  --由于调用及回调赋值时机需要高契合度所以写在本脚本中，随后的Notify更新也写在本脚本中
...
----------------------------------------------------------------------
function GuildNoAPI:MyselfPreparingGuildDetailResponseHandler(e)
...
--]]
------------------------------------------------增加战队成员人数上限--
function GuildNoAPI:AddGuildMemberSizeRequest()  
...
----------------------------------------------------------------------
function GuildNoAPI:AddGuildMemberSizeResponseHandler(e)
...
function GuildNoAPI:InitializeMyselfPreparingGuildDetailMembers(PreparingGuild)  --初始化自己战队筹备成员
      --先清空子物体
...
function GuildNoAPI:InitializeMyselfPreparingGuildDetailInfo(PreparingGuild)  --初始化自己战队筹备信息
      ...
      --赋值右侧完毕，跳转进入
      GuildNoAPI.Instance:ShowPanel("I","I2M");  -------------------------------------------------------->>
      
end
-------------------------------------------------------------------------------------------------
function GuildNoAPI:InitializeMyselfGuildDetailMembers(Guild)
...
-------------------------------------------------------------------------------------------------
function GuildNoAPI:InitializeMyselfGuildDetailMembers_Co(Guild)  --战队--信息--成员
...
function GuildNoAPI:InitializeMyselfGuildDetailInfoCoin()
...
-------------------------------------------------------------------------------------------------
function GuildNoAPI:InitializeMyselfGuildDetailInfo(Guild)     --战队--信息--信息
      ...
      --赋值右侧完毕，跳转进入
      --GuildNoAPI.Instance:ShowPanel("II","II1");  另外一处更慢一点，在那里打开  -------------------------------------------------------->>

end
-------------------------------------------------------------------------------------------------
function GuildNoAPI:InitializeMyselfGuildMembers(Members)
...
-------------------------------------------------------------------------------------------------
function GuildNoAPI:InitializeMyselfGuildMembers_Co(Members)      --战队--成员--成员
...
-------------------------------------------------------------------------------------------------
function GuildNoAPI:InitializeMyselfGuildInfo(Guild)           --战队--成员--信息
...
-------------------------------------战队星级赋值----------------------------------
function GuildNoAPI:ShowStarLevel(t,sun,moon,star)
...
-------------------------------------------------------------------------战队签到--
function GuildNoAPI:GuildSignInRequest()    
...
----------------------------------------------------------------------
function GuildNoAPI:GuildSignInResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------申请列表--
function GuildNoAPI:GuildApplicationListRequest( beginIndex , length )   --索引，增量  Type：RequestGuildApplicationList
...
----------------------------------------------------------------------
function GuildNoAPI:GuildApplicationListResponseHandler(e)
  ...
  if e.Type == "RequestGuildApplicationList" then
    ...
    elseif(data.Result==1)then  
      ...
      if(GuildNoAPI~=nil and GuildNoAPI.Instance~=nil )then
        GuildNoAPI.Instance.II2_ApplicationPoint.gameObject:SetActive(false)  --此界面的红点
      end
...
----------------------------------------------------------------------------------------------------------------同意申请--
function GuildNoAPI:AgreeGuildApplicationRequest( applicationId  )   --Type：RequestAgreeGuildApplication
...
----------------------------------------------------------------------
function GuildNoAPI:AgreeGuildApplicationResponseHandler(e)    
...
----------------------------------------------------------------------------------------------------------------拒绝申请--
function GuildNoAPI:RefuseGuildApplicationRequest( applicationId  )   --Type：RequestRefuseGuildApplication
...
----------------------------------------------------------------------
function GuildNoAPI:RefuseGuildApplicationResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------战队日志--
function GuildNoAPI:GuildLogListRequest()    --RequestGuildLogList
...
----------------------------------------------------------------------
function GuildNoAPI:GuildLogListResponseHandler(e)
...
function GuildNoAPI:ChangeGuildConfigRequest(guildIconId,guildIsCheck,guildLimitLevel,guildLimitGrade)    --RequestChangeGuildConfig
...
----------------------------------------------------------------------
function GuildNoAPI:ChangeGuildConfigResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------修改战队宣言--
function GuildNoAPI:ChangeGuildDeclarationRequest(guildDeclaration )    --RequestChangeGuildDeclaration
...
----------------------------------------------------------------------
function GuildNoAPI:ChangeGuildDeclarationResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------退出战队--
function GuildNoAPI:LeaveGuildRequest()   --Type：RequestLeaveGuild
...
----------------------------------------------------------------------
function GuildNoAPI:LeaveGuildResponseHandler(e)    
...
----------------------------------------------------------------------------------------------------------------战队招募CD--
function GuildNoAPI:GuildInviteCD(second)
  self.Co_CountDownRevive= coroutine.start(self.GuildInviteCD_Co ,self , second) 
end
function GuildNoAPI:GuildInviteCD_Co(second)
...
----------------------------------------------------------------------------------------------------------------战队招募--
function GuildNoAPI:SendGuildInvitationRequest()   
...
function GuildNoAPI:SendGuildInvitationResponseHandler(e)    
...
---------------------------------------
function GuildNoAPI:DoGoToStorePanel(page)
  -- body
  coroutine.start(self.GoToStorePanel, self,page) 

end

function GuildNoAPI:GoToStorePanel(page)
  -- body
...
---------------------------------------
function GuildNoAPI:InitializeGuildLastWeekRank(guildRanks)     --获取上周战队排行  self.GuildLastWeekRank
      --先清空子物体
...
---------------------------------------
function GuildNoAPI:InitializeGuildWeekRank(guildRanks)         --获取本周战队排行  self.GuildWeekRank
...
---------------------------------------
function GuildNoAPI:InitializeGuildLevelSeasonRank(guildRanks)  --获取战队当前等级的赛季排行榜  self.GuildLevelSeasonRank
...
---------------------------------------
function GuildNoAPI:InitializeGuildSeasonRank(guildRanks)       --获取战队赛季排行榜  self.GuildSeasonRank
...
function GuildNoAPI:MyselfApplyingGuildsRequest()    
...
function GuildNoAPI:MyselfApplyingGuildsResponseHandler(e)
  if(GuildNoAPI.Instance==nil) then return true end 
...
-----------------------------------------------------开除队员---------------------------------------------------
function GuildNoAPI:GuildFireMemberRequest(targetMemberId )    
...
function GuildNoAPI:GuildFireMemberResponseHandler(e)
...
-----------------------------------------------------队长传位---------------------------------------------------
function GuildNoAPI:GuildLeaderDemiseRequest(targetMemberId )    --Type：RequestGuildLeaderDemise
...
function GuildNoAPI:GuildLeaderDemiseResponseHandler(e)
...
-----------------------------------------------------任命副队长------------------------------------------
function GuildNoAPI:GuildAppointViceLeader(targetMemberId)
...
-----------------------------------------------------任命副队长请求---------------------------------------------------
function GuildNoAPI:GuildAppointViceLeaderRequest(targetMemberId,replaceMemberId )    --Type：RequestGuildAppointViceLeader
...
function GuildNoAPI:GuildAppointViceLeaderResponseHandler(e)
...
--获取上周战队排行 : WYL
--***************************
function GuildNoAPI:GuildLastWeekRankRequest()   --RequestGuildLastWeekRank
...
function GuildNoAPI:GuildLastWeekRankResponseHandler(e)
...
--获取本周战队排行 : WYL
--***************************
function GuildNoAPI:GuildWeekRankRequest()   --Type：RequestGuildWeekRank
  if(UTGData.Instance().PlayerData.GuildStatus~=1)then return end  --如果没有加入战队，退出
...
function GuildNoAPI:GuildWeekRankResponseHandler(e)
  ...
  if e.Type == "RequestGuildWeekRank" then
    ...
    if GuildNoAPI ~= nil and GuildNoAPI.Instance ~= nil then
      GuildNoAPI.Instance:InitializeMyselfGuildDetailInfoCoin()
    end
    --填充自己战队的排名
...
--获取战队当前等级的赛季排行榜 : WYL
--***************************
function GuildNoAPI:GuildLevelSeasonRankRequest()   --RequestGuildLevelSeasonRank
  if(UTGData.Instance().PlayerData.GuildStatus~=1)then return end  --如果没有加入战队，退出
...
function GuildNoAPI:GuildLevelSeasonRankResponseHandler(e)
...
--获取战队赛季排行榜 : WYL
--***************************
function GuildNoAPI:GuildSeasonRankRequest()   --RequestGuildSeasonRank
...
function GuildNoAPI:GuildSeasonRankResponseHandler(e)
...
function GuildNoAPI:ChangeFlagShowNewApplicationRequest(bool)
...
----------------------------------------------------------------------
function GuildNoAPI:ChangeFlagShowNewApplicationResponseHandler(e)
...
---------------------------------添加好友-----------------------------
function GuildNoAPI:AddFriendRequest(Id)
...
----------------------------------------------------------------------
function GuildNoAPI:AddFriendResponseHandler(e)

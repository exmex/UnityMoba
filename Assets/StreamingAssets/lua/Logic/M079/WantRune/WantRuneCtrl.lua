...
function WantRuneCtrl:Awake(this) 
  self.this = this
...
function WantRuneCtrl:Start()
  
end

function WantRuneCtrl:Init()

end

function WantRuneCtrl:OnDestroy()
  self.this = nil
  self = nil
end

function WantRuneCtrl:dataInit(args)
  self.tabItem = UITools.CopyTab(Data.GrowUpGuideRune)
  --≈≈–Ú∞¥’’id
...
function WantRuneCtrl:itemCreate(tabTmp)
...
function WantRuneCtrl:itemUiSet(trans,info)

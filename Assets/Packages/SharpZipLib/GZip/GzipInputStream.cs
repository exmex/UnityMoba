...
namespace ICSharpCode.SharpZipLib.GZip 
{
	...
	public class GZipInputStream : InflaterInputStream
	{
        ...
        public GZipInputStream(Stream baseInputStream, Inflater inflater, int size)
            : base(baseInputStream, inflater, size)
        {
        }

        public GZipInputStream(Stream baseInputStream, Inflater inflater, int size, byte[] buffer)
            : base(baseInputStream, inflater, size, buffer)
        {
        }
		#endregion	

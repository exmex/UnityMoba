...
namespace ICSharpCode.SharpZipLib.GZip 
{
	...
	public class GZipOutputStream : DeflaterOutputStream
	{
        ...
        public GZipOutputStream(Stream baseOutputStream, Deflater deflater, int size)
            : base(baseOutputStream, deflater, size)
        {
        }

        public GZipOutputStream(Stream baseOutputStream, Deflater deflater, int size, byte[] buffer)
            : base(baseOutputStream, deflater, size, buffer)
        {
        }
		#endregion

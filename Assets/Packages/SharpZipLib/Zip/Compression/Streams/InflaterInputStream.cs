...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams 
{
	...
	public class InflaterInputBuffer
	{
        ...
        public InflaterInputBuffer(Stream stream, int bufferSize, byte[] buffer)
        {
            inputStream = stream;
            if (bufferSize < 1024)
            {
	...
	public class InflaterInputStream : Stream
	{
        ...
        public InflaterInputStream(Stream baseInputStream, Inflater inflater, int bufferSize, byte[] buffer)
        {
            if (baseInputStream == null)
            {
                throw new ArgumentNullException("baseInputStream");
            ...
            inputBuffer = new InflaterInputBuffer(baseInputStream, bufferSize, buffer);
        }

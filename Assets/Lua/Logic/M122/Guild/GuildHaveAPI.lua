...
class("GuildHaveAPI")
----------------------------------------------------
function GuildHaveAPI:Awake(this) 
  self.this = this  
  -------------------------------------
  GuildHaveAPI.Instance=self;
  -------------------------------------
  self:SetParam() 
...
function GuildHaveAPI:Start()
  ...
  self.topAPI:GoToPosition("GuildHavePanel")
...
----------------------------------------------------
function GuildHaveAPI:OnDestroy() 
  coroutine.stop(self.Co_CountDownRevive)
  
  ------------------------------------
  GuildHaveAPI.Instance=nil;
  ------------------------------------
  self.this = nil
  self = nil
...
------------------------------------------参数赋值--
function GuildHaveAPI:SetParam()  --引用及初始值
...
------------------------------------------------------------
function GuildHaveAPI:ShowPanel(index1,index2)  --指定打开某节点，及其某子节点，关闭其他
...
------------------------------------------------------------
function GuildHaveAPI:Initialize() 
...
------------------------------------------------------------
function GuildHaveAPI:OnButtonClick_I1()  --战队列表
  --self:ShowPanel("I","I1"); 
...
function GuildHaveAPI:OnButtonClick_I2()  --筹备战队列表
...
function GuildHaveAPI:OnButtonClick_I3()  --筹备战队列表

  self:ShowPanel("I","I3");  ------------------------------------------------------------------------------------------------->>

end
function GuildHaveAPI:OnButtonClick_II1()  --战队-信息-界面
...
function GuildHaveAPI:OnButtonClick_II2()  --战队-成员-界面
...
function GuildHaveAPI:OnButtonClick_III1()  --战队-排行榜-本周
...
function GuildHaveAPI:OnButtonClick_III2()  --战队-排行榜-上周
...
function GuildHaveAPI:OnButtonClick_III3()  --战队-排行榜-赛季跳转
...
function GuildHaveAPI:OnButtonClick_III3I()  --战队-排行榜-同等级赛季
...
function GuildHaveAPI:OnButtonClick_III3II()  --战队-排行榜-赛季
...
------------------------------------------------------------
function GuildHaveAPI:AddListener()
...
function GuildHaveAPI:Instantiate(mTable,prefabName,parent,obj,func,single)
...
function GuildHaveAPI:InstantiateCoro(mTable,prefabName,parent,obj,func,single)
    local amount=0
...
-----------------------------------------------赋值回调--
function GuildHaveAPI:Assignment_GuildIcon(go,key,guildIcon)  --赋值战队图标
...
function GuildHaveAPI:Assignment_GuildIconII(go,key,guildIcon)  --赋值战队图标II
...
function GuildHaveAPI:Assignment_GuildList(go,key,v)  --赋值战队列表 --guildInfo
...
function GuildHaveAPI:Assignment_PreparingGuildList(go,key,v) --赋值筹备列表 
...
function GuildHaveAPI:Assignment_PreparingGuildMembers(go,key,v) --赋值成员列表  --data.PreparingGuild.PreparingGuildInfo  --data.PreparingGuild.Members 
...
----------------------------------------
function GuildHaveAPI:DoGoToPlayerDataPanel(v)
  -- body
  coroutine.start(self.GoToPlayerDataPanel, self,v)
end

function GuildHaveAPI:GoToPlayerDataPanel(v)
  -- body
...
----------------------------------------
function GuildHaveAPI:DoGoToGuildListPanel()
  -- body
  coroutine.start(self.GoToGuildListPanel, self,v)
end

function GuildHaveAPI:GoToGuildListPanel()
  -- body
...
-------------------------------------------------------------------------------------------------------------加入战队后--
function GuildHaveAPI:Assignment_GuildMembers(go,key,v,index,isEnd) --战队信息 
...
function GuildHaveAPI:DoInNextFrame(func,obj,param1,param2) 
  coroutine.start(self.DoInNextFrame_Co,self,func,obj,param1,param2)
end
function GuildHaveAPI:DoInNextFrame_Co(func,obj,param1,param2) 
  --coroutine.step()
  while(true)do
    coroutine.step()
...
function GuildHaveAPI:Assignment_GuildLogList(go,key,v,index)  
...
-------------------------------------------------------------------------------------------------------------加入战队后--
function GuildHaveAPI:ShowNumII(num,tempo) --排行数字 
...
function GuildHaveAPI:ShowNum(num,tempo) --排行数字 
...
-------------------------------------------------------------------------------------------------------------加入战队后--
function GuildHaveAPI:Assignment_GuildMembersII(go,key,v,index) --战队成员 
...
function GuildHaveAPI:GetStringTime(t)
...
--------------------------------------------------------------------------------获取战队申请列表--
function GuildHaveAPI:Assignment_ApplicationList(go,key,v,index) --战队成员
...
function GuildHaveAPI:Assignment_GuildLastWeekRank(go,key,v,index) --获取上周战队排行
...
function GuildHaveAPI:Assignment_GuildWeekRank(go,key,v,index) --获取上周战队排行
...
function GuildHaveAPI:Assignment_GuildLevelSeasonRank(go,key,v,index) --获取上周战队排行
...
function GuildHaveAPI:Assignment_GuildSeasonRank(go,key,v,index) --获取上周战队排行
...
function GuildHaveAPI:InitSelf_GuildLastWeekRank(v)
  --------------------------将自己战队信息填充到界面底部-----------------------
...
function GuildHaveAPI:InitSelf_GuildWeekRank(v)
...
function GuildHaveAPI:InitSelf_GuildLevelSeasonRank(v)
...
function GuildHaveAPI:InitSelf_GuildSeasonRank(v)
...
----------------------------------------------------------------------------------------------------------------创建战队--
function GuildHaveAPI:CreateGuildRequest()  
...
function GuildHaveAPI:RefreshI3()  --刷新创建战队界面  
...
----------------------------------------------------------------------
function GuildHaveAPI:CreateGuildResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------获取战队列表--
function GuildHaveAPI:GuildListRequest( beginIndex , length )   --索引，增量
...
----------------------------------------------------------------------
function GuildHaveAPI:GuildListResponseHandler(e)
...
--------------------------------------------------------------------------------------------------------------申请加入战队--
function GuildHaveAPI:ApplyGuildRequest(guildId)   
...
----------------------------------------------------------------------
function GuildHaveAPI:ApplyGuildResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------搜索战队--
function GuildHaveAPI:SearchGuildRequest()  --RequestSearchGuild
...
----------------------------------------------------------------------
function GuildHaveAPI:SearchGuildResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------获取筹备列表--
function GuildHaveAPI:PreparingGuildListRequest( beginIndex , length )   --索引，增量  RequestPreparingGuildList
...
----------------------------------------------------------------------
function GuildHaveAPI:PreparingGuildListResponseHandler(e)
...
--------------------------------------------------------------------------------------------------------------响应筹备战队--
function GuildHaveAPI:JoinPreparingGuildRequest(guildId)   
...
----------------------------------------------------------------------
function GuildHaveAPI:JoinPreparingGuildResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------搜索筹备战队--
function GuildHaveAPI:SearchPreparingGuildRequest()  --RequestSearchGuild
...
----------------------------------------------------------------------
function GuildHaveAPI:SearchPreparingGuildResponseHandler(e)
...
--[[
----------------------------------------------------------------------------------------------------------------筹备中--
function GuildHaveAPI:MyselfPreparingGuildDetailRequest()  --由于调用及回调赋值时机需要高契合度所以写在本脚本中，随后的Notify更新也写在本脚本中
...
----------------------------------------------------------------------
function GuildHaveAPI:MyselfPreparingGuildDetailResponseHandler(e)
...
--]]
------------------------------------------------增加战队成员人数上限--
function GuildHaveAPI:AddGuildMemberSizeRequest()  
...
----------------------------------------------------------------------
function GuildHaveAPI:AddGuildMemberSizeResponseHandler(e)
...
function GuildHaveAPI:InitializeMyselfPreparingGuildDetailMembers(PreparingGuild)  --初始化自己战队筹备成员
      --先清空子物体
...
function GuildHaveAPI:InitializeMyselfPreparingGuildDetailInfo(PreparingGuild)  --初始化自己战队筹备信息
      ...
      --赋值右侧完毕，跳转进入
      GuildHaveAPI.Instance:ShowPanel("I","I2M");  -------------------------------------------------------->>
      
end
-------------------------------------------------------------------------------------------------
function GuildHaveAPI:InitializeMyselfGuildDetailMembers(Guild)
...
-------------------------------------------------------------------------------------------------
function GuildHaveAPI:InitializeMyselfGuildDetailMembers_Co(Guild)  --战队--信息--成员
...
function GuildHaveAPI:InitializeMyselfGuildDetailInfoCoin()
...
-------------------------------------------------------------------------------------------------
function GuildHaveAPI:InitializeMyselfGuildDetailInfo(Guild)     --战队--信息--信息
      ...
      --赋值右侧完毕，跳转进入
      --GuildHaveAPI.Instance:ShowPanel("II","II1");  另外一处更慢一点，在那里打开  -------------------------------------------------------->>

end
-------------------------------------------------------------------------------------------------
function GuildHaveAPI:InitializeMyselfGuildMembers(Members)
...
-------------------------------------------------------------------------------------------------
function GuildHaveAPI:InitializeMyselfGuildMembers_Co(Members)      --战队--成员--成员
...
-------------------------------------------------------------------------------------------------
function GuildHaveAPI:InitializeMyselfGuildInfo(Guild)           --战队--成员--信息
...
-------------------------------------战队星级赋值----------------------------------
function GuildHaveAPI:ShowStarLevel(t,sun,moon,star)
...
-------------------------------------------------------------------------战队签到--
function GuildHaveAPI:GuildSignInRequest()    
...
----------------------------------------------------------------------
function GuildHaveAPI:GuildSignInResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------申请列表--
function GuildHaveAPI:GuildApplicationListRequest( beginIndex , length )   --索引，增量  Type：RequestGuildApplicationList
...
----------------------------------------------------------------------
function GuildHaveAPI:GuildApplicationListResponseHandler(e)
  ...
  if e.Type == "RequestGuildApplicationList" then
    ...
    elseif(data.Result==1)then  
      ...
      if(GuildHaveAPI~=nil and GuildHaveAPI.Instance~=nil )then
        GuildHaveAPI.Instance.II2_ApplicationPoint.gameObject:SetActive(false)  --此界面的红点
      end
...
----------------------------------------------------------------------------------------------------------------同意申请--
function GuildHaveAPI:AgreeGuildApplicationRequest( applicationId  )   --Type：RequestAgreeGuildApplication
...
----------------------------------------------------------------------
function GuildHaveAPI:AgreeGuildApplicationResponseHandler(e)    
...
----------------------------------------------------------------------------------------------------------------拒绝申请--
function GuildHaveAPI:RefuseGuildApplicationRequest( applicationId  )   --Type：RequestRefuseGuildApplication
...
----------------------------------------------------------------------
function GuildHaveAPI:RefuseGuildApplicationResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------战队日志--
function GuildHaveAPI:GuildLogListRequest()    --RequestGuildLogList
...
----------------------------------------------------------------------
function GuildHaveAPI:GuildLogListResponseHandler(e)
...
function GuildHaveAPI:ChangeGuildConfigRequest(guildIconId,guildIsCheck,guildLimitLevel,guildLimitGrade)    --RequestChangeGuildConfig
...
----------------------------------------------------------------------
function GuildHaveAPI:ChangeGuildConfigResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------修改战队宣言--
function GuildHaveAPI:ChangeGuildDeclarationRequest(guildDeclaration )    --RequestChangeGuildDeclaration
...
----------------------------------------------------------------------
function GuildHaveAPI:ChangeGuildDeclarationResponseHandler(e)
...
----------------------------------------------------------------------------------------------------------------退出战队--
function GuildHaveAPI:LeaveGuildRequest()   --Type：RequestLeaveGuild
...
----------------------------------------------------------------------
function GuildHaveAPI:LeaveGuildResponseHandler(e)    
...
----------------------------------------------------------------------------------------------------------------战队招募CD--
function GuildHaveAPI:GuildInviteCD(second)
  self.Co_CountDownRevive= coroutine.start(self.GuildInviteCD_Co ,self , second) 
end
function GuildHaveAPI:GuildInviteCD_Co(second)
...
----------------------------------------------------------------------------------------------------------------战队招募--
function GuildHaveAPI:SendGuildInvitationRequest()   
...
function GuildHaveAPI:SendGuildInvitationResponseHandler(e)    
...
---------------------------------------
function GuildHaveAPI:DoGoToStorePanel(page)
  -- body
  coroutine.start(self.GoToStorePanel, self,page) 

end

function GuildHaveAPI:GoToStorePanel(page)
  -- body
...
---------------------------------------
function GuildHaveAPI:InitializeGuildLastWeekRank(guildRanks)     --获取上周战队排行  self.GuildLastWeekRank
      --先清空子物体
...
---------------------------------------
function GuildHaveAPI:InitializeGuildWeekRank(guildRanks)         --获取本周战队排行  self.GuildWeekRank
...
---------------------------------------
function GuildHaveAPI:InitializeGuildLevelSeasonRank(guildRanks)  --获取战队当前等级的赛季排行榜  self.GuildLevelSeasonRank
...
---------------------------------------
function GuildHaveAPI:InitializeGuildSeasonRank(guildRanks)       --获取战队赛季排行榜  self.GuildSeasonRank
...
function GuildHaveAPI:MyselfApplyingGuildsRequest()    
...
function GuildHaveAPI:MyselfApplyingGuildsResponseHandler(e)
...
-----------------------------------------------------开除队员---------------------------------------------------
function GuildHaveAPI:GuildFireMemberRequest(targetMemberId )    
...
function GuildHaveAPI:GuildFireMemberResponseHandler(e)
...
-----------------------------------------------------队长传位---------------------------------------------------
function GuildHaveAPI:GuildLeaderDemiseRequest(targetMemberId )    --Type：RequestGuildLeaderDemise
...
function GuildHaveAPI:GuildLeaderDemiseResponseHandler(e)
...
-----------------------------------------------------任命副队长------------------------------------------
function GuildHaveAPI:GuildAppointViceLeader(targetMemberId)
...
-----------------------------------------------------任命副队长请求---------------------------------------------------
function GuildHaveAPI:GuildAppointViceLeaderRequest(targetMemberId,replaceMemberId )    --Type：RequestGuildAppointViceLeader
...
function GuildHaveAPI:GuildAppointViceLeaderResponseHandler(e)
...
--获取上周战队排行 : WYL
--***************************
function GuildHaveAPI:GuildLastWeekRankRequest()   --RequestGuildLastWeekRank
...
function GuildHaveAPI:GuildLastWeekRankResponseHandler(e)
...
--获取本周战队排行 : WYL
--***************************
function GuildHaveAPI:GuildWeekRankRequest()   --Type：RequestGuildWeekRank
  if(UTGData.Instance().PlayerData.GuildStatus~=1)then return end  --如果没有加入战队，退出
...
function GuildHaveAPI:GuildWeekRankResponseHandler(e)
...
--获取战队当前等级的赛季排行榜 : WYL
--***************************
function GuildHaveAPI:GuildLevelSeasonRankRequest()   --RequestGuildLevelSeasonRank
  if(UTGData.Instance().PlayerData.GuildStatus~=1)then return end  --如果没有加入战队，退出
...
function GuildHaveAPI:GuildLevelSeasonRankResponseHandler(e)
...
--获取战队赛季排行榜 : WYL
--***************************
function GuildHaveAPI:GuildSeasonRankRequest()   --RequestGuildSeasonRank
...
function GuildHaveAPI:GuildSeasonRankResponseHandler(e)
...
function GuildHaveAPI:ChangeFlagShowNewApplicationRequest(bool)
...
----------------------------------------------------------------------
function GuildHaveAPI:ChangeFlagShowNewApplicationResponseHandler(e)
...
---------------------------------添加好友-----------------------------
function GuildHaveAPI:AddFriendRequest(Id)
...
----------------------------------------------------------------------
function GuildHaveAPI:AddFriendResponseHandler(e)
